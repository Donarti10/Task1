...
export const dataDomain  = [
    ...
    },
    {
        ...
        text:'Can the domain name be used on an internation scale?',
    },
    {
        id:5,
        icon:icon5,
        title:'Search engine',
        text:'Does the domain follow search engine guidelines?',
    },
    {
        id:6,
        icon:icon6,
        title:'Advertising Potential',
        text:'Could the domain be used for advertising campaigns?',
    },
    {
        id:7,
        icon:icon7,
